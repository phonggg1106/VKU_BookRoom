...
export const TIME_SLOTS: TimeSlot[] = [
  ...
  {
    id: 'slot-3',
    label: 'Tiết 7 - 9 (Chiều)',
    timeRange: '13:00 - 15:15',
    period: 'afternoon',
  },
  {
    id: 'slot-4',
    label: 'Tiết 10 - 12 (Chiều)',
    timeRange: '15:30 - 17:45',
    period: 'afternoon',
  },
  {
    id: 'slot-5',
    label: 'Ca Tối (Nghiên cứu / CLB)',
...
// Dữ liệu đặt phòng mẫu đã có sẵn trên hệ thống (để chứng minh tính năng Chống trùng lịch - Conflict Prevention hoạt động)
export const INITIAL_BOOKINGS: Booking[] = [
  {
    ...
    campus: 'Khu K',
    floor: 1,
    date: getFormattedDate(0).dateString,
    dateDisplay: getFormattedDate(0).displayString,
    slotId: 'slot-1',
    slotLabel: 'Tiết 1 - 3 (Sáng)',
    slotTime: '07:00 - 09:15',
    purpose: 'Ôn tập Đồ án Lập trình Di động React Native',
    studentId: DEFAULT_USER.studentId,
    studentName: DEFAULT_USER.name,
    studentEmail: DEFAULT_USER.email,
    status: 'confirmed',
  ...
  },
  {
    ...
    dateDisplay: getFormattedDate(0).displayString,
    slotId: 'slot-3',
    slotLabel: 'Tiết 7 - 9 (Chiều)',
    slotTime: '13:00 - 15:15',
    purpose: 'Họp CLB Tin học VKU Tech Club',
    studentId: '22IT888',
    studentName: 'Lê Hoàng Long',
    studentEmail: 'longlh.22it@vku.udn.vn',
    status: 'confirmed',
    createdAt: new Date().toISOString(),
  },
  {
    ...
    campus: 'Khu K',
    floor: 1,
    date: getFormattedDate(1).dateString,
    dateDisplay: getFormattedDate(1).displayString,
    slotId: 'slot-2',
    slotLabel: 'Tiết 4 - 6 (Sáng)',
    slotTime: '09:30 - 11:45',
    purpose: 'Nghiên cứu Đề tài Sinh viên NCKH VKU',
    studentId: '21IT055',
    studentName: 'Phạm Thị Thảo',
    studentEmail: 'thaopt.21it@vku.udn.vn',
    status: 'confirmed',
    createdAt: new Date().toISOString(),
  }
];
